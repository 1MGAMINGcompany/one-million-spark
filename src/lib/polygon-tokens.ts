/**
 * Canonical Polygon token configuration.
 *
 ...
 *
 * User-facing label: "USDC" (never expose "USDC.e" to end users)
 */

/** Bridged USDC (USDC.e) — the canonical trading & settlement token */
export const USDC_E_CONTRACT = "0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174" as const;

/** Native Circle USDC — only used in swap-to-USDC.e flow, NOT for trading */
export const USDC_NATIVE_CONTRACT = "0x3c499c542cEF5E3811e1192ce70d8cC03d5c3359" as const;
...
export const USDC_DISPLAY_SYMBOL = "USDC" as const;
