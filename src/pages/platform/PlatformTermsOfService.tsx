    ...
    <div className="min-h-screen bg-[#06080f] text-white py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8">
          <Section title={t("legal.terms.s1Title")} body={t("legal.terms.s1Body")} />
          <Section title={t("legal.terms.s2Title")} body={t("legal.terms.s2Body")} />
          <Section title={t("legal.terms.s3Title")} body={t("legal.terms.s3Body")} />
          <Section title={t("legal.terms.s4Title")} body={t("legal.terms.s4Body")} />
          <Section title={t("legal.terms.s5Title")} body={t("legal.terms.s5Body")} />
          <Section title={t("legal.terms.s6Title")} body={t("legal.terms.s6Body")} />
        </div>
      </div>
    </div>
  );
