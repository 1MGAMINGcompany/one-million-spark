CREATE OR REPLACE FUNCTION public.record_match_result(p_room_pda text, p_finalize_tx text, p_winner_wallet text, p_game_type text, p_max_players integer, p_stake_lamports bigint, p_mode text, p_players text[])
 RETURNS void
 LANGUAGE plpgsql
 SECURITY DEFINER
