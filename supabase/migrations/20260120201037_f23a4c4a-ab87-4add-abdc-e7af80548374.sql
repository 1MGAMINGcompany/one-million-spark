-- Update submit_game_move RPC to handle auto_forfeit and reject moves on finished games
-- Also add server-side timeout validation
...
BEGIN
  ...
  -- PART B FIX: Reject moves on finished games
  ...
  -- PART B FIX: Server-side timeout validation (anti-cheat)
  ...
  -- PART B FIX: Handle auto_forfeit - mark game as finished
